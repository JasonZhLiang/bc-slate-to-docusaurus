...
### CreateGroup()Â Script

Parameters for Tut3_CreateGroup()
```js
{
Â  Â  Â "groupName": "The Tater Tots"
}
```
...
results;
```
## Step 2 - Test the Group ManagementÂ scripts
...
Now that we've got the groups being created, letsÂ put the code in place to manage the members.
